...
from app.routers import projects, servers, databases, settings as settings_router, components, auth, users, groups, audit_router, notifications as notifications_router, project_folders as project_folders_router, trash as trash_router, mfa as mfa_router
...
app.include_router(project_folders_router.router)
